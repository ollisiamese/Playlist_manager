   ...
   self.length=ko.computed(function(){
	               ...
	               if(self.tracks()&&self.tracks()!=''&&self.tracks()!=undefined&&self.tracks().length>0){
						  ...
						  for(var i=0;i<self.tracks().length;i++){
						    ...
						    var mins=parseInt(self.tracks()[i].duration.slice(0,breakpoint));
		                  
						    var secs=parseInt(self.tracks()[i].duration.slice(breakpoint+1));
	                ...
	                else{ //no tracks in this list, length=0
